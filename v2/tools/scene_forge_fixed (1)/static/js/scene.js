...
export class SceneManager {
  ...
  setMode(mode) {
    ...
    if (mode === 'orbit') {
      ...
      // BUGFIX: _flyYaw/_flyPitch controlam a rotação a cada mousemove.
      // Sem resincronizar aqui, o primeiro movimento do mouse depois de
      // trocar de modo fazia a câmera "saltar" pra uma direção antiga
      // (o valor de yaw/pitch da última vez que se usou o modo voar).
      const euler = new THREE.Euler(0, 0, 0, 'YXZ')
      euler.setFromQuaternion(this.flyCam.quaternion)
