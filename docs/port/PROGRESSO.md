...
| **F6** | Meta-jogo | Menus, inventário, mapa, files, FMV HD, finais, Mercenários | Completável do título ao epílogo nos 2 finais + Mercenários | 12 | █░░░░░░░ 16% | █░░░░░░░ 13% |
...
- [~] **P6-02** (peso 3, impl 88%, valid 74%) — Inventário/status fiel (grade 2x5, EQUIP/USE/COMBINE/CHECK, ECG, ícones HD)
...
- [~] **P6-04** (peso 2, impl 60%, valid 45%) — Files/memos (280 HD) + tabela de mensagens EN/PT
  ...
  - **Nota:** FEITA a tela (port/present/menu_arquivo.gd), aberta pelo botao ARQ. do menu de status. O texto dos documentos e BITMAP pre-renderizado (FILEGU.PIX): 31 documentos, 183 paginas de 128x256, extraidas em port/assets/FILE/. Tamanhos medidos nos descritores de 0x8009f2ec: capa 128x168 (a arte ocupa so as 168 primeiras linhas das 256), pagina de texto 256x176, setas 12x12. Icones da lista = ETC/FILEI.TIM, grade 4x8 de 32x32 (32 celulas para 31 docs). Lista com nome em PT e navegacao por pagina. DECLARADO nao medido: a posicao de tela das primitivas (0x8006e600 escreve u,v,clut,w,h mas nao x,y, que vem de buffers de RAM) — centralizo em 320x240; e o de-para documento->celula do FILEI (uso celula = doc). FALTA: as paginas em PT — o pack tem memo/ com 280 imagens 1024x768 = 4x de 256x192 (e nao de 128x256), ou seja o HD redesenhou em outro formato; casar as 280 com os 183 slots e o proximo passo.
